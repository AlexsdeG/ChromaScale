...
import { Plus, Wand2, Image as ImageIcon, Loader2, Sparkles, Terminal, UploadCloud, X, Download, Bot, Zap, Undo2, Dices, Github } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 bg-black/80 backdrop-blur-md border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Github Link */}
            <a
              href="https://github.com/AlexsdeG/ChromaScale"
              target="_blank"
              rel="noreferrer"
              className="p-2 hover:bg-white/10 rounded-full transition-colors focus:outline-none focus:bg-white/10 text-zinc-400 hover:text-white"
            >
              <Github size={20} />
            </a>
          </div>
